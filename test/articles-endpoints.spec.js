...
describe('Articles Endpoints', function() {
    ...
    describe(`POST /api/articles`, () => {
        it(`creates an article, responding with 201 and new article`, function() {
            this.retries(3)
            const newArticle = {
                title: 'New test article title',
                style: 'Listicle',
                content: 'Test article new content...'
            }
            return supertest(app)
                .post('/api/articles')
                .send(newArticle)
    ...
    describe(`PATCH /api/articles/:article_id`, () => {
        ...
        context('Given there are articles in the db', () => {
            ...
            it('responds with 204 and updates the article', () => {
              ...
              it(`responds with 204 wehn updating only a subset of fields`, () => {
                    const idToUpdate = 2
                    const updateArticle = {
                        title: 'updated article title',
                    }
